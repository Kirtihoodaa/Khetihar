...
import 'package:khetihar/HomePages/AgricultureTools/Controller/AgricultureToolsController.dart';
import 'package:khetihar/Theme/AppColors.dart';
import 'package:khetihar/Theme/FontSize.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class AgricultureTools extends StatelessWidget {
  final ToollsEquipmentController _controller = Get.put(
    ToollsEquipmentController(),
  );

  final TextEditingController _searchController = TextEditingController();

  AgricultureTools({super.key});
                  ...
                  Expanded(
                    child: Obx(
                      () => CustomButton(
                        text: "Tools",
                        onPressed:
                            () => _controller.selectedTab.value = FPTab.Tools,
                        variant:
                            _controller.selectedTab.value == FPTab.Tools
                        ...
                        onPressed:
                            () =>
                                _controller.selectedTab.value =
                                    FPTab.Equipments,
                        variant:
                            _controller.selectedTab.value == FPTab.Equipments
                                ? ButtonVariant.filled
                                : ButtonVariant.outline,
                        backgroundColor:
                            _controller.selectedTab.value == FPTab.Equipments
